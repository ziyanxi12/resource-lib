...
import { Button, Modal, Input, Select, message, List, Tabs, Tag, Table, Space } from 'antd'
...
export default function InnerShow() {
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ marginBottom: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        <h2 style={{ margin: 0, fontSize: 18, fontWeight: 600 }}>已登录用户</h2>
        <Space>
          <Input.Search
            allowClear
            placeholder="搜索账号/昵称"
